...
describe('HeroService', () => {
  ...
  const initialHeroes: Hero[] = [
    { id: 1, name: 'Superman', power: 'Vuelo', universe: 'DC' },
    { id: 2, name: 'Spiderman', power: 'Telarañas', universe: 'Marvel' },
  ];
  ...
  it('should add a new hero with incremental ID', () => {
    const newHero: Hero = { id: 0, name: 'Ironman', power: 'Armadura', universe: 'Marvel' };
